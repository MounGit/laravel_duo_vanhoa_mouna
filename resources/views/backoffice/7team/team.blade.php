    ...
    <div>
        <section class="container">
            ...
            <div class="container d-flex justify-content-center">
                <a class="btn btn-success mt-3 mb-5 fs-4" href="{{route('teams.create')}}">Ajouter un nouveau Team</a>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div class="d-flex justify-content-around my-3">
                                        ...
                                        <a class="btn btn-warning" href="{{route('teams.edit', $data->id)}}">Modifier</a>
